...
WebUI.click(findTestObject('Object Repository/WEB/Page_CURA Healthcare Service/td_27'))

WebUI.setText(findTestObject('Object Repository/WEB/Page_CURA Healthcare Service/textarea_Comment_comment'), 'this is a demo comment')
